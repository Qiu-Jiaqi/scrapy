...
import scrapy
import json
from taptap.items import QuadraticItem
from bs4 import BeautifulSoup


# 二次元游戏
class QuadraticSpider(scrapy.Spider):
    name = 'quadratic'
    allowed_domains = ['www.taptap.com']
    start_urls = ['https://www.taptap.com/ajax/search/tags?&kw=%E4%BA%8C%E6%AC%A1%E5%85%83&sort=hits&page=1']
