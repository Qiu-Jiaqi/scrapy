...
import scrapy
import json
from taptap.items import AloneItem
from bs4 import BeautifulSoup


# 单机游戏
class AloneSpider(scrapy.Spider):
    name = 'alone'
    allowed_domains = ['www.taptap.com']
    start_urls = ['https://www.taptap.com/ajax/search/tags?&kw=%E5%8D%95%E6%9C%BA&sort=hits&page=1']
