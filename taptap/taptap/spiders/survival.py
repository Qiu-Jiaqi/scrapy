...
import scrapy
import json
from taptap.items import SurvivalItem
from bs4 import BeautifulSoup


# 生存游戏
class SurvivalSpider(scrapy.Spider):
    name = 'survival'
    allowed_domains = ['www.taptap.com']
    start_urls = ['https://www.taptap.com/ajax/search/tags?&kw=%E7%94%9F%E5%AD%98&sort=hits&page=1']
